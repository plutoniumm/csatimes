...
name: 'timelines',
  data () {
    ...
    start1: null, summary1: null, name1: null,
    start2: null, summary2: null, name2: null,
    start3: null, summary3: null, name3: null,
    start4: null, summary4: null, name4: null,
    start5: null, summary5: null, name5: null
    }
  },
  mounted () {
        axios.get('https://csa.devsoc.club/api/v1/en/student/show', { headers: {token: AuthStr} })
         .then(response => {
         (this.start1 = response.en.reverse()[0].start), (this.summary1 = response.en.reverse()[0].summary),
         (this.start2 = response.en.reverse()[1].start), (this.summary2 = response.en.reverse()[1].summary),
         (this.start3 = response.en.reverse()[2].start), (this.summary3 = response.en.reverse()[2].summary),
         (this.start4 = response.en.reverse()[3].start), (this.summary4 = response.en.reverse()[3].summary),
         (this.start5 = response.en.reverse()[4].start), (this.summary5 = response.en.reverse()[4].summary),
         (this.name1 = response.en.reverse()[0].name),(this.name2 = response.en.reverse()[1].name),
         (this.name3 = response.en.reverse()[2].name),(this.name4 = response.en.reverse()[3].name),
